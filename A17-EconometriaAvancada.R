#Aula 17 - Metodologia Box- Jenkings ~ Econometria Avancada
...
install.packages("rugarch") #Ler Pacotes

library(rugarch) #Carregando Pasotes
library(readxl) #Carregando Pasotes
library(aTSA)   #Carregando Pasotes
library(tseries)#Carregando Pasotes
library("urca") #Carregando Pasotes
library(forecast) #Carregando Pasotes
